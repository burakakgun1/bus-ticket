    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col">
            <label htmlFor="trip_id" className="text-sm font-semibold">
              Sefer ID
            </label>
            <input
              id="trip_id"
          ...
          <div className="flex flex-col">
            <label htmlFor="departure_time" className="text-sm font-semibold">
              Kalkış Zamanı
            </label>
            <input
              id="departure_time"
                ...
                <tr key={bus.bus_id} className="border-b">
                  {editingBus && editingBus.bus_id === bus.bus_id ? (
                    ...
                    <>
                      ...
                      <td className="py-2 px-4">
                        <input
                          type="number"
                          name="departure_time"
                          value={editingBus.departure_time}
                          min="0"
                          max="23"
                          onChange={handleInputChange}
                          className="w-full border p-1"
                    ...
                    <>
                      ...
                      <td className="py-2 px-4 text-center">
                        {formatDepartureTime(bus.departure_time)}
                      </td>
                      <td className="py-2 px-4 text-center">
                        <button
