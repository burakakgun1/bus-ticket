...
import { FaTimes, FaUser, FaEnvelope, FaPhone, FaEdit, FaRegEye, FaRegEyeSlash } from "react-icons/fa";
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 transition pr-10"
                  />
                  <button
                    type="button"
